var data = [
  ...
  { id: '', type: 'allin', color: '#1b87e6', text: 'Grifo', ikon: '' },
  // Modificar Premio Beats
  { id: '', type: 'quiz', color: '#1b3380', text: 'Ninfa' },
  // Modificar Premio Airpods
  { id: '', type: 'quiz', color: '#1b87e6', text: 'Quimera' },
  // Modificar Premio Tarjeta
  { id: '', type: 'quiz', color: '#1b3380', text: 'Dragon' },
  // Modificar Premio Beats - 2
  { id: '', color: '#1b87e6', text: 'Unicornio', ikon: '' },
  // Modificar Premio Airpods - 2
  { id: '', color: '#1b3380', text: 'Hidra' },
  // Modificar Premio Tequila QP - 2
  { id: '', color: '#1b87e6', text: 'Medusa' },
  // Modificar Premio Dashboard
  { id: '', type: 'time', color: '#1b3380', text: 'Manticora', ikon: '' },
  // Modificar premio Netflix
  { id: '', type: 'question', color: '#1b87e6', text: 'Centauro' },
  // Modificar premio Cine QP
  { id: '', color: '#1b3380', text: 'Minotauro' },
  // Modificar premio Airpods - 2
  { id: '', color: '#1b87e6', text: 'Esfinge' },
  // Modificar premio Jugar de nuevo
  { id: '', type: 'replay', color: '#1b3380', text: 'Dios aleatorio', ikon: 'replay' }
];
